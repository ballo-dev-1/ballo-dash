...
const teamData = [
  {
    ...
    img: avatar2,
    members: [
      { img: avatar4, name: "john week" },
      { img: avatar6, name: "Lazaro" },
      { img: avatar7, name: "nia" },
      { img: avatar8, name: "John Doe" },
    ],
    memberList: 1,
    location: "India",
  },
  {
    ...
    members: [
      { img: avatar1, name: "" },
      { img: avatar5, name: "leen" },
      { img: avatar3, name: "Adeline" },
      { img: avatar4, name: "john week" },
    ],
    memberList: 5,
    location: "Indonasia",
