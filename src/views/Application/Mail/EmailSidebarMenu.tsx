...
// const EmailSidebarMenu = ({ toggleTab, activeTab, siteBarToggle }: any) => {
...
//                     <div id="mail-menulist" className={`collapse collapse-horizontal ${siteBarToggle === true ? 'show' : ''}`}>
...
//                                     </div>
//                                 </div>
//                                 <SimpleBar className={`scroll-block ${siteBarToggle===true ? 'simplebar-scrollable-y':''}`}>
//                                     <Card.Body className="p-0">
//                                         <div className="list-group list-group-flush" id="list-tab">
//                                             <Link className={`list-group-item list-group-item-action ${activeTab === "Inbox" ? 'active' : ''}`} href="#list-mail-1"
//                                                 onClick={() => toggleTab("Inbox", "all", "all")}>
//                                                 <span> <i className="ti ti-inbox"></i>  Inbox  </span>
//                                                 <span className="avtar avtar-xs">4</span>
//                                             </Link>
//                                             <Link className={`list-group-item list-group-item-action ${activeTab === "Sent" ? 'active' : ''}`} href="#list-mail-3"
//                                                 onClick={() => toggleTab("Sent", "all", "all")}>
//                                                 <span><i className="ti ti-send"></i> Sent </span>
//                                             </Link>
//                                             <Link className={`list-group-item list-group-item-action ${activeTab === "Draft" ? 'active' : ''}`} href="#list-mail-4"
//                                                 onClick={() => toggleTab("Draft", "all", "all")}>
//                                                 <span><i className="ti ti-file-text"></i> Draft</span>
//                                             </Link>
//                                             <Link className={`list-group-item list-group-item-action ${activeTab === "Spam" ? 'active' : ''}`} href="#list-mail-5"
//                                                 onClick={() => toggleTab("Spam ", "all", "all")}>
//                                                 <span><i className="ti ti-alert-triangle"></i> Spam </span>
//                                             </Link>
//                                             <Link className={`list-group-item list-group-item-action ${activeTab === "Trash" ? 'active' : ''}`} href="#list-mail-6"
//                                                 onClick={() => toggleTab("Trash", "all", "all")}>
//                                                 <span> <i className="ti ti-trash text-danger"></i>Trash</span>
//                                                 <span className="avtar avtar-xs">2</span>
//                                             </Link>
//                                             <Link className={`list-group-item list-group-item-action ${activeTab === "Archive" ? 'active' : ''}`} href="#list-mail-3"
//                                                 onClick={() => toggleTab("Archive", "all", "all")}>
