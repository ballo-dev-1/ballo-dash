...
import { onAddNewEvent, onUpdateEvent, onDeleteEvent } from "../../../toolkit/Calendar/reducer";
    ...
    return (
        <React.Fragment>
            ...
            <Offcanvas show={addEventModal} onHide={() => { handleModal(); setModal(false); setEvent(null) }} placement="end">
                <Offcanvas.Header closeButton className="justify-content-between align-items-center">
