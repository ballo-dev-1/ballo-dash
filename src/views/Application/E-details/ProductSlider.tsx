                ...
                <div className="sticky-md-top product-sticky">
                    <div id="carouselExampleCaptions" className="carousel slide ecomm-prod-slider" data-bs-ride="carousel">
                        ...
                        <Swiper
                            ...
                            className="mySwiper2">
                            <SwiperSlide>
                                <Image src={product1} width={700} className="d-block rounded-3" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product2} width={700} className="d-block rounded-3" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product3} width={700} className="d-block rounded-3" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product4} width={700} className="d-block rounded-3" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product5} width={700} className="d-block rounded-3" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product6} width={700} className="d-block rounded-3" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product7} width={700} className="d-block rounded-3" alt="Product images" />
                            </SwiperSlide>
                            <SwiperSlide>
                                <Image src={product8} width={700} className="d-block rounded-3" alt="Product images" />
                            </SwiperSlide>
                        </Swiper>
