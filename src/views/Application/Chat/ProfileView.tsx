                        ...
                        <SimpleBar className="scroll-block" data-simplebar="init">
                            <Card.Body className="p-0">
                                <Form.Check className="form-switch d-flex align-items-center justify-content-between p-0">
                                    ...
                                    <Form.Check.Input className="h5 m-0 position-relative" type="checkbox" id="customSwitchemlnot1" defaultChecked />
                                </Form.Check>
                                <hr className="my-3 border border-secondary-subtle" />
                                <Link href="#" className="btn border-0 p-0 text-start w-100" onClick={() => setShow(!show)}>
                                ...
                                <Collapse in={show}>
                                    <div className="py-3">
                                        ...
                                        <div className="d-flex align-items-center justify-content-start mb-2">
                                            ...
                                            <p className="mb-0 text-muted ms-2"><Link href="#" className="link-primary">Light able.com</Link></p>
                                        </div>
                                ...
                                <hr className="my-3 border border-secondary-subtle" />
                                <Link href='#' className="btn border-0 p-0 text-start w-100" onClick={() => setFileCollapse(!fileCollapse)}>
                                    <div className="float-end"><i className="ti ti-chevron-down"></i></div>
                                ...
                                <Collapse in={fileCollapse}>
                                    <div className="py-3">
                                        <div className="media align-items-center mb-2">
                                            <Link href="#" className="avtar avtar-s btn-light-success">
                                        ...
                                        <div className="media align-items-center mb-2">
                                            <Link href="#" className="avtar avtar-s btn-light-danger">
                                        ...
                                        <div className="media align-items-center mb-2">
                                            <Link href="#" className="avtar avtar-s btn-light-primary">
