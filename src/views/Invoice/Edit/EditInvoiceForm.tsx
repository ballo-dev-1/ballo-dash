        ...
        <React.Fragment>
            <Col sm={6} xl={3}>
                <div className="mb-0">
                    ...
                    <input type="text" name='invoiceId' className="form-control" placeholder="#xxxx" value={formData.invoiceId} readOnly onChange={handleInputChange} />
                </div>
            </Col>
            <Col sm={6} xl={3}>
                <div className="mb-0">
                    <label className="form-label">Status</label>
                    <select className="form-select" name='status' id="exampleFormControlSelect1" value={formData.status} onChange={handleInputChange}>
            ...
            <Col sm={6} xl={3}>
                <div className="mb-0">
                    ...
                    <input type="datetime-local" name='startDate' className="form-control" value={formData.startDate} onChange={handleInputChange} />
                </div>
            </Col>
            <Col sm={6} xl={3}>
                <div className="mb-0">
                    <label className="form-label">Due Date</label>
                    <input type="datetime-local" name='dueDate' className="form-control" value={formData.dueDate} onChange={handleInputChange} />
                </div>
            </Col>
            <Col xl={6}>
                <div className="border rounded p-3 h-100">
                    <div className="d-flex align-items-center justify-content-between mb-2">
                        ...
                        <button
                            ...
                            onClick={handleDisplay}><i className="ph-duotone ph-pencil-simple-line"></i> Change</button>
                    </div>
                                                ...
                                                <span className="row align-items-center justify-content-between">
                                                    ...
                                                    <span className="col-6 text-end">
                                                        <span className="address-btns d-flex align-items-center justify-content-end">
                                                            <Link href="#" className="avtar avtar-s btn-link-danger btn-pc-default mx-1">
