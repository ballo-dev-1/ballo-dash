                            ...
                            <Row className="justify-content-between align-items-center mb-3 g-3">
                                <Col sm="auto">
                                    <Form className="form-search">
                                        ...
                                        <Button variant="light" className="btn btn-light-secondary btn-search">Search</Button>
                                    </Form>
                                </Col>
                                <Col sm="auto">
                                            ...
                                            <Row className="g-3">
                                                ...
                                                <Col sm={12}>
                                                    ...
                                                    <div className="text-start">
                                                        <button className="btn btn-sm btn-light-primary"><i className="ti ti-plus"></i> Add new item</button>
                                                        <hr className="mb-0" />
                                                    </div>
                                                </Col>
                                                <Col sm={12}>
