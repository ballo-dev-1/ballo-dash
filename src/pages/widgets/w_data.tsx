          ...
          <Card>
            <Card.Body className="pb-0">
              <div className="d-flex align-items-center">
                ...
                <i
                  className="ph-duotone ph-info f-20 ms-1"
              ...
              <div className="d-flex align-items-start my-3">
                ...
                <span className="badge bg-light-success ms-2">
                  <i className="ti ti-arrow-up me-1"></i> 3.4%
                </span>
              </div>
            </Card.Body>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="text-end">
                        <i className="ti ti-arrow-up text-success"></i> 4.0%
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td className="text-end">7.04</td>
                      <td className="text-end">
                        <i className="ti ti-arrow-up text-success"></i> 2.0%
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td className="text-end">
                        <i className="ti ti-arrow-down text-danger"></i> 1.4%
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="table table-hover table-borderless mb-0">
                  <tbody>
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          <Image
                            src={GERMANY}
                            alt=""
                            className="img-fluid wid-30 rounded-1"
                          />
                      ...
                      <td>
                        <i className="ti ti-arrow-up text-success f-18 align-text-bottom"></i>{" "}
                        5.8%
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        <i className="ti ti-arrow-down text-danger f-18 align-text-bottom"></i>{" "}
                        51.2%
                      </td>
                    </tr>
                    <tr>
              ...
              <div className="latest-update-box">
                <div className="row p-t-20 p-b-30">
                  ...
                  <div className="col">
                    ...
                    <p className="text-muted m-b-0">
                      The trip was an amazing and a life changing experience!!
                    </p>
                  </div>
                </div>
                <div className="row p-b-30">
                  ...
                  <div className="col">
                    ...
                    <p className="text-muted m-b-0">
                      Free courses for all our customers at A1 Conference Room -
                      9:00 am tomorrow!
                    </p>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-auto text-end update-meta">
                    ...
                    <div className="border border-2 border-danger text-danger update-icon">
                      N
                    </div>
                  </div>
                  <div className="col">
