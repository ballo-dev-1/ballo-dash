...
import { LAYOUT_LANGUAGES } from "@common/layoutConfig";
...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    const storedOpenMenu = storedOpenMenuString
      ? JSON.parse(storedOpenMenuString)
      : {};
    const initialOpenMenu: any = {};

    const checkSubmenu = (submenu: any) => {
      if (!submenu) return false;
      return submenu.some((subItem: any) =>
